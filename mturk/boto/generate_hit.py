...
if __name__ == '__main__':
	...
	parser.add_argument("--count", type=int, choices=[0,6,12], default=6, 
		help="The number of sentences in the qualification test. Default is 6, and if 0 no qualification test is assigned.")
	parser.add_argument("--tol", type=int, choices=[0,67,84], default=67,
		help="The percentage of sentences coded correctly in order to pass qualification test. Default is 67, and if 0 no qualification test is assigned.")
	...
	# Only add qualification test if we are using one in this experiment
	if i > 0 and c > 0:
